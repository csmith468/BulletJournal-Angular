...
GO
ALTER TABLE [app].[spendingRegular]  WITH CHECK ADD  CONSTRAINT [FK_SpendingRegularUser] FOREIGN KEY([UserID])
REFERENCES [app_sys].[user] ([UserID])
GO
ALTER TABLE [app].[spendingRegular] CHECK CONSTRAINT [FK_SpendingRegularUser]
GO
