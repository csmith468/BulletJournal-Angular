...
GO
ALTER TABLE [app].[spendingFinancial]  WITH CHECK ADD  CONSTRAINT [FK_SpendingFinancialUser] FOREIGN KEY([UserID])
REFERENCES [app_sys].[user] ([UserID])
GO
ALTER TABLE [app].[spendingFinancial] CHECK CONSTRAINT [FK_SpendingFinancialUser]
GO
