...
GO
CREATE TABLE [checklist].[morning](
...
GO
ALTER TABLE [checklist].[morning] ADD PRIMARY KEY CLUSTERED 
(
	[id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, SORT_IN_TEMPDB = OFF, IGNORE_DUP_KEY = OFF, ONLINE = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
GO
ALTER TABLE [checklist].[morning]  WITH CHECK ADD  CONSTRAINT [FK_morningUser] FOREIGN KEY([userID])
REFERENCES [app].[user] ([userID])
GO
ALTER TABLE [checklist].[morning] CHECK CONSTRAINT [FK_morningUser]
GO
