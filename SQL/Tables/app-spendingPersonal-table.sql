...
GO
ALTER TABLE [app].[spendingPersonal]  WITH CHECK ADD  CONSTRAINT [FK_spendingPersonal_User] FOREIGN KEY([UserID])
REFERENCES [app].[user] ([UserID])
GO
ALTER TABLE [app].[spendingPersonal] CHECK CONSTRAINT [FK_spendingPersonal_User]
GO
