...
namespace API.Data.Repositories {
    public class NightRepository : IChecklistRepository<NightChecklist> {
        ...
        public async Task<NightChecklist> AddAsync(NightChecklist nightChecklist) {
        ...
        public async Task<PagedList<NightChecklist>> GetListAsync(int userId, PageParams pageParams) {
        ...
        public async Task<NightChecklist> GetByIdAsync(int userId, int nightChecklistId) {
